...
Laduje zmienne srodowiskowe i definiuje stale konfiguracyjne.
"""
...
ENCODER_DEVICE: str = os.getenv("ENCODER_DEVICE", "auto")  # "auto", "cpu", "cuda"
...
# === Kolory klastrow (zsynchronizowane z frontendem) ===
...
# === Polskie stop words (do TF-IDF / c-TF-IDF) ===
